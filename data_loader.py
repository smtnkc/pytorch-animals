...
def get_data_loaders(args):
    ...
    if args.debug:
        display_single(img_folders, cfg.NORMALIZE, cfg.CATEGORIES, img_id=153)  # 153 is arbitrarily chosen
        display_multiple(args, cfg.NORMALIZE, cfg.CATEGORIES, data_loaders, N=4)  # display 4 images
